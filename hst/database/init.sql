-- Script de inicialización alternativo para MySQL
-- Ejecutar con: mysql -u root -p < database/init.sql

-- Crear base de datos
DROP DATABASE IF EXISTS hst_db;
CREATE DATABASE IF NOT EXISTS hst_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE hst_db;
...
CREATE TABLE pacientes (
    ...
    KEY idx_pacientes_nombre (nombre, apellido)
...
CREATE TABLE doctores (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    KEY idx_doctores_dni (dni),
    KEY idx_doctores_especialidad (especialidad)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE emergencias (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    KEY idx_emergencias_fecha (fecha_hora),
    KEY idx_emergencias_estado (estado_salud)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Insertar datos de ejemplo para Doctores
...
-- Insertar datos de ejemplo para Pacientes
...
-- Insertar datos de ejemplo para Emergencias
